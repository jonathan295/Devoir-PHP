...
<form method="post" action="afficher_evaluation.php" class="formulaire">
   <FIELDSET>
 <LEGEND align=top>Les mati�res correspondantes<LEGEND>  
   <?php
   $i=6;
...
<thead><tr><th scope="col" class="rounded-company">Evaluation</th><th scope="col" class="rounded-q1">Mati�re</th><th scope="col" class="rounded-q2">Date_devoir</th><th scope="col" class="rounded-q3">Classe</th><th scope="col" class="rounded-q3">Coefficient</th><th scope="col" class="rounded-q3">Semestre</th><th scope="col" class="rounded-q4">1er/2eme devoir</th></tr></thead>
<tfoot>
<tr>
...
<br/><br/><a href="afficher_evaluation.php">Revenir � la page principale !</a></center>
<?php
...
echo '<td><a href="modif_eval.php?modif_eval='.$a['numeval'].'">modifier</a></td><td><a href="modif_eval.php?supp_eval='.$a['numeval'].'" onclick="return(confirm(\'Etes-vous s�r de vouloir supprimer cette entr�e?\'));">supprimer</a></td>';}
...
Veuillez choisir le Semestre, la promotion et la classe : <br/><br/>
   <FIELDSET>
 <LEGEND align=top>Crit�res d'affichage<LEGEND>  <pre>
