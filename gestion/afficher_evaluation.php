...
echo '<td><a href="modif_eval.php?modif_eval='.$a['numeval'].'"><img style="width: 20px;" src="/gestion/image/editer.png" alt="modifier"></a></td><td><a href="modif_eval.php?supp_eval='.$a['numeval'].'" onclick="return(confirm(\'Etes-vous sûr de vouloir supprimer cette entrée?\'));"><img style="width: 20px;" src="/gestion/image/supprimer.png" alt="supprimer"></a></td>';}
