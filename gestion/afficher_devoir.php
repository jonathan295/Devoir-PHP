...
echo '<td><a href="modif_devoir.php?modif_dev='.$a['numdev'].'"><img style="width: 20px;" src="/gestion/image/editer.png" alt="modifier"></a></td><td><a href="modif_devoir.php?supp_dev='.$a['numdev'].'" onclick="return(confirm(\'Etes-vous s�r de vouloir supprimer cette entr�e?\ntous les enregistrements en relation avec cette entr�e seront perdus\'));"><img style="width: 20px;" src="/gestion/image/supprimer.png" alt="supprimer"></td>';} echo '<td>'.$a['nommat'].'</td><td>'.$a['date_dev'].'</td><td>'.$a['nom'].'</td><td>'.$a['coeficient'].'</td><td>S'.$a['numsem'].'</td><td>'.$a['n_devoir'].'</td></tr>';
}
?>
</tbody>
</table>
