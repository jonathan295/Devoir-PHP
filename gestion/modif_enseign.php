...
echo '<a href="/gestion/index.php">Revenir à la page principale</a>'; //on revient � la page princippale car on n'a plus l'id dont on affiche la matiere dans la modification
}
?>
</div>
