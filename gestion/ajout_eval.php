...
Veuillez choisr la mati�re : <br/><br/>
   <?php
   $i=6;
...
<br/><br/><a href="ajout_eval.php">Revenir � la page principale !</a></center>
<?php
...
<br/><br/><a href="ajout_eval.php">Revenir � la page principale </a>
<?php
}
else{
...
?>
<form method="POST" action="ajout_eval.php" class="formulaire">
Fili�re                 :          <?php echo $nomcl.' - '.$promo; ?><br/>
Mati�re                :           <?php echo $nommat; ?><br/>
