<?php
    ...
    if ($_SERVER["PHP_SELF"] == "/gestion/pages/form/traitement/inscription_recup.php") {
        if (isset($_POST["inscription"])){
            ...
            if (empty($nom_err) && empty($prenom_err) && empty($email_err) && empty($password_err) && empty($tel_err) && empty($adresse_err) && empty($type_err) && empty($date_naissance_err)) {
                ...
                if ($stmt) {
                    ...
                    if ($type=="etudiant"){
                        if (mysqli_stmt_execute($stmt)){
                            ...
                            header("location: /gestion/pages/form/connexion.php");
                        } else {
                ...
                header("location: /gestion/pages/form/inscription.php");
            }
